...
class InputControl extends Component {
  ...
  // 处理手写
  handleCount = (e) => {
    this.props.onComplete(Math.ceil(+e.target.value));
  }
  ...
  handleBlur(e) {
    if (!isNaN(e.target.value) && parseInt(e.target.value) > 0) {
      ...
      // this.input.input.value = this.props.num;
    }
  }
      ...
      <div className="inputplus-control-wrapper ml10">
        <span className="input-group-addon days-icon">
          <span
            ...
            disabled={this.props.num <= this.props.min ? true : false}
          >
        ...
        <span className="input-group-addon days-icon">
          <span
            ...
            disabled={this.props.num >= 99999 ? true : false}
          >
